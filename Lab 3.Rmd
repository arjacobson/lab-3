...
library(MASS)
df <- Cars93
training <- sample(1:nrow(df), 40, replace=FALSE)
...
## Ask how to find the number of USA and non-USA cars in the training dataset. Is it similar to what we did in the first lab?
```
